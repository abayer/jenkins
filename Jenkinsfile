...
//        flow.fetch_installers(debfile, rpmfile, susefile)
        fetch_installers(debfile, rpmfile, susefile)
...
//        flow.execute_install_testset(extendedTests, stepNames)
        execute_install_testset(coreTests, stepNames)
        execute_install_testset(extendedTests, stepNames)
    }
...
def fetch_artifact(String url) {
    if (url == null) {
        ...
        echo "comp.artifact: ${comp.artifact}"
        echo "comp.item: ${comp.item}"
        echo "comp.run: ${comp.run}"
